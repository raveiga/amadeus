...
class Basedatos {
     ...
     */
    public function insertarUsuario($nick, $password, $nombre, $apellidos, $dni, $email, $telefono, $tipo = 'local') {
...
// fin función Insertar.
     ...
     */
    public function chequearAcceso($nick, $pass, $autenticacion) {
        if ($autenticacion == 'local') {
            // Preparamos la consulta.
            $nick = strtolower($nick);
